...
var databaseUrl = 'mongodb://localhost/redit';
...
app.get("/scrape", function(req, res) {
	request("https://old.reddit.com/r/homelab/", function(error, response, html) {
		...
		$("div.thing").each(function(i, element) {
			...
			var img = $(element).find("a.thumbnail").find("img").attr("src");
			result.link = link;
			result.title = title;
			// if (summary) {
